...
$(document).ready(function() {   
    ...
    $("#deshebideshe_search").focus(function(){
        if($(this).attr("value")=="দেশে বিদেশে সার্চ"){
            $(this).attr("value","");
            $(this).css({
                'color':'#000'
            });
    ...
    $("#deshebideshe_search").blur(function(){
        if($(this).attr("value")==""){
            $(this).attr("value","দেশে বিদেশে সার্চ");
            $(this).css({
                'color':'#999'
            });
        }
    ...
    $('#post_an_ad').mouseover(function() {
        var content = $('div.tip span');
        $(content).css('z-index','100');
        $(content).fadeTo('slow', 1);
    });
    $('#post_an_ad').mouseout( function() {
        var content = $('div.tip span');
    ...
    $('#post_an_ad1').mouseover(function() {
        var content = $('div.tip1 span');
        $(content).css('z-index','100');
        $(content).fadeTo('slow', 1);
    });
    $('#post_an_ad1').mouseout( function() {
        var content = $('div.tip1 span');
        $(content).css('z-index','3');
        $(content).fadeTo('slow', 0.0);
    ...
    $.xui.tabs = $.extend(tabs, {
        ...
        _create: function() {
            ...
            if (o.scrollable) {
                ...
                var navPrev = $('<li class="ui-tabs-arrow-previous ui-state-default ui-corner-bl ui-corner-tl" title="Previous"><a href="#"><span class="ui-icon ui-icon-circle-triangle-w">Previous tab</span></a></li>').prependTo(arrowsNav).hide(),
                navNext = $('<li class="ui-tabs-arrow-next ui-state-default ui-corner-tr ui-corner-br" title="Next"><a href="#"><span class="ui-icon ui-icon-circle-triangle-e">Next tab</span></a></li>').appendTo(arrowsNav).hide();
