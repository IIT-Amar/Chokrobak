        ...
        <div class="row" id="channel">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-success"> BD Celebrities</a>
                    <a href="#" class="list-group-item list-group-item-info">Young Tatents</a>
                    <a href="#" class="list-group-item list-group-item-success">Athletes</a>
                    <a href="#" class="list-group-item list-group-item-info">Writters</a>
                    ...
                    <a href="#" class="list-group-item list-group-item-info">Achievement</a>
                    <a href="#" class="list-group-item list-group-item-success">Contributions</a>
                    <a href="#" class="list-group-item list-group-item-info">Feedback</a>
                </div>
            </div>
            <div class="col-md-9">
                <embed name="lsplayer" wmode="opaque" bgcolor="#000000" src="http://cdn.livestream.com/grid/LSPlayer.swf?channel=banglatvuk&amp;clip=&amp;time=&amp;height=340&amp;width=560&amp;autoplay=true" width="100%" height="100%" allowscriptaccess="always" allowfullscreen="true" type="application/x-shockwave-flash">
            </div>
        </div>
